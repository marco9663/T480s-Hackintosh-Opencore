 ...
 *
 * Disassembly of C:/Users/marco/SSDTTime/Results/DSDT.aml, Thu Dec 10 13:13:08 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0002206C (139372)
 *     Revision         0x02
 *     Checksum         0xF1
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "SKL     "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "SKL     ", 0x00000000)
{
    ...
    Name (SS4, One)
    One
    OperationRegion (GNVS, SystemMemory, 0x6B558000, 0x0792)
    ...
    OperationRegion (MNVS, SystemMemory, 0x6B568018, 0x1000)
    ...
    Scope (\_SB.PCI0.LPCB.EC)
    {
        ...
        {
            Fatal (0x01, 0x80010000, 0x00011FF2)
        }
    ...
    Scope (\_SB.PCI0.LPCB.EC.HKEY)
    {
        ...
        Method (NVST, 1, NotSerialized)
        {
            ...
            If ((ANGN && (\_SB.PCI0.LPCB.DGON != 0x00)))
            {
